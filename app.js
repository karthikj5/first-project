...
app.post('/update', function (request, response) {
	...
	var sql = 'UPDATE gatepass SET status = ? where id = ?'
...
app.post('/status', function (request, response) {
	...
	connection.query('SELECT * FROM gatepass where name like ?', [un], function (err, rows) {
...
app.get('/thome', function (request, response) {
	...
	connection.query('SELECT * FROM gatepass where status = "Pending"', function (err, rows) {
...
app.post('/updategate', function (request, response) {
	...
	//var location = document.location;
	var sql = 'UPDATE gatepass SET status = ?, outtime = CURRENT_TIMESTAMP where id = ?'
